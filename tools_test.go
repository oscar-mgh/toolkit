...
var slugTests = []struct {
	...
	{name: "complex string", s: "Now is the time for all GOOD people!!!+321+++----#$/", expected: "now-is-the-time-for-all-good-people-321", errorExpected: false},
	{name: "japanese string", s: "私たちはコーディングが大好きです", expected: "", errorExpected: true},
	{name: "japanese string and roman characters", s: "hello world 私たちはコーディングが大好きです", expected: "hello-world", errorExpected: false},
}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	if res.Header["Content-Length"][0] != "102395" {
...
var jsonTests = []struct {
	...
	{name: "two json files", json: `{"foo":"some"}{"alpha":"beta"}`, errorExpected: true, maxSize: 1024, allowUnknown: false},
	...
	{name: "allow unknown fileds in json", json: `{"fooo":"bar"}`, errorExpected: false, maxSize: 1024, allowUnknown: true},
	...
	{name: "not json", json: `hello world`, errorExpected: true, maxSize: 5, allowUnknown: true},
}
