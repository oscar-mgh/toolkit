...
// CreateDirIfNotExists creates a directory and all necesary parents, if it does not exist
...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns the response, status code and error
